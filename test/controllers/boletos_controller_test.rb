...
class BoletosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boleto" do
    assert_difference("Boleto.count") do
      post boletos_url, params: { boleto: { codigo: @boleto.codigo, valor: @boleto.valor, vencimento: @boleto.vencimento } }
    end
  ...
  test "should update boleto" do
    patch boleto_url(@boleto), params: { boleto: { codigo: @boleto.codigo, valor: @boleto.valor, vencimento: @boleto.vencimento } }
